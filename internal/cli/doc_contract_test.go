...
func TestReducedSurfaceDocContract_PopFileScopeAndCanonicalNames(t *testing.T) {
	...
	assertContainsNormalized(t, popHelp, `{"status":"message","message_id":"filename.md","markdown_path":"~/.local/state/tmux-a2a-postman/.../read/filename.md","markdown_absolute_path":"/absolute/path/to/read/filename.md","body_available":true,"body_reference":"markdown_absolute_path","body_bytes":123,"body_omitted_reason":"externalized_to_markdown_path","frontmatter":{"params":{...}},"from":"...","to":"...","timestamp":"...","unread_before":1,"remaining":0}`)
	assertContainsNormalized(t, popHelp, "Use markdown_absolute_path when present for programmatic file reads.")
	assertContainsNormalized(t, popHelp, "pop claims and archives the message; it does not push full body text inline.")
