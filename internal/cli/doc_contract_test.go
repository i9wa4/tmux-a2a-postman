...
func TestReducedSurfaceDocContract_PopFileScopeAndCanonicalNames(t *testing.T) {
	...
	assertContainsNormalized(t, sendHelp, `{"sent":"filename.md","status":"processed","context_id":"...","session":"...","from":"sender","to":"recipient","reply_policy":"required","submit_path":"daemon-submit"}`)
