...
func TestRunHelp_ConfigShowsUnifiedModelAndPublicKnobs(t *testing.T) {
	...
	for _, want := range []string{
		...
		"Skill catalogs:",
		"context skill_path relative paths resolve from the declaring postman.md directory",
		"inject: ping and compaction_skill_path paths must be ~/... or absolute",
		"inject: ping may use runtime: claude or runtime: codex for compaction-triggered PING catalogs",
