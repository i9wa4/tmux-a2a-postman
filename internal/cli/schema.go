	...
	case "":
		return enc.Encode(jsonSchema{
			...
			Properties: map[string]schemaProperty{
				...
				"journal_health_cutover_enabled":        {Type: "boolean", Description: "Enable journal-backed canonical health reads while keeping legacy reads"},
				"journal_compatibility_cutover_enabled": {Type: "boolean", Description: "Enable compatibility-submit reads for owned sessions (requires journal_health_cutover_enabled)"},
