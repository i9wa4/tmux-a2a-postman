...
func runHelp(stdout, stderr io.Writer, args []string) error {
	...
	case "config":
		...
		fmt.Fprintln(stdout, "  journal_compatibility_cutover_enabled  Enable compatibility-submit reads for owned sessions")
		...
		fmt.Fprintln(stdout, "  legacy                 Default. Legacy health and direct pop; send submits to owned daemons.")
		fmt.Fprintln(stdout, "  health-first           Enable journal-backed canonical health while pop remains direct.")
		fmt.Fprintln(stdout, "  compatibility-first    Enable journal-backed health plus compatibility-submit pop.")
