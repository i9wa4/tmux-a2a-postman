...
var helpTopicFiles = map[string]string{
	...
	"backfill-verdict-events":               "helptext/backfill-verdict-events.txt",
	...
	"execute-bash":                          "helptext/execute-bash.txt",
	"inspect-command-approvals":             "helptext/inspect-command-approvals.txt",
	...
	"reconcile-command-approval-reply-slot": "helptext/reconcile-command-approval-reply-slot.txt",
