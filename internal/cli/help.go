...
func runHelp(stdout, stderr io.Writer, args []string) error {
	...
	if len(args) == 0 {
		...
		fmt.Fprintln(stdout, "  get-health-oneline         Print a compact all-session formatter over canonical health")
		fmt.Fprintln(stdout, "")
	...
	case "commands":
		...
		fmt.Fprintln(stdout, "  Print a compact all-session formatter over the canonical health sweep.")
