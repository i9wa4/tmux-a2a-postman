...
func runHelp(stdout, stderr io.Writer, args []string) error {
	...
	if len(args) == 0 {
		...
		fmt.Fprintln(stdout, "by the daemon. Use send-message to send and pop to read.")
		fmt.Fprintln(stdout, "")
		fmt.Fprintln(stdout, "Quick Start:")
		fmt.Fprintln(stdout, "  1. Start daemon:    tmux-a2a-postman start")
		fmt.Fprintln(stdout, "  2. Send a message:  tmux-a2a-postman send-message --to <node> --body \"text\"")
		...
		fmt.Fprintln(stdout, "  start                      Start the daemon (TUI dashboard)")
		fmt.Fprintln(stdout, "  stop                       Stop the running daemon for this tmux session")
		fmt.Fprintln(stdout, "  send-message               Send a message in one step (--to and --body required)")
		fmt.Fprintln(stdout, "  pop                        Read and archive the oldest unread inbox message")
		fmt.Fprintln(stdout, "  read                       List inbox message file paths")
		fmt.Fprintln(stdout, "  get-session-status-oneline Print pane status (emoji in pipes/tmux #(), ANSI in TTY)")
		fmt.Fprintln(stdout, "  get-session-health         Print session health per node")
		...
		fmt.Fprintln(stdout, "  send-message --to <node> --body \"text\"  Send a message in one step")
	...
	case "messaging":
		...
		fmt.Fprintln(stdout, "  Send:  tmux-a2a-postman send-message --to <node> --body \"text\"")
		fmt.Fprintln(stdout, "  Read:  tmux-a2a-postman pop")
		fmt.Fprintln(stdout, "")
		fmt.Fprintln(stdout, "Reply workflow:")
		fmt.Fprintln(stdout, "  tmux-a2a-postman send-message --to <sender> --body \"DONE: ...\"")
		fmt.Fprintln(stdout, "")
		fmt.Fprintln(stdout, "  To reply in same context thread:")
		fmt.Fprintln(stdout, "    tmux-a2a-postman send-message --to <sender> --context-id <id> --body \"...\"")
	...
	case "directories":
		...
		fmt.Fprintln(stdout, "          ├── draft/          # internal: draft staging area (use send-message instead)")
	...
	case "commands":
		...
		fmt.Fprintln(stdout, "")
		fmt.Fprintln(stdout, "send-message")
		...
		fmt.Fprintln(stdout, "    tmux-a2a-postman send-message --to orchestrator --body \"DONE: task complete\"")
		fmt.Fprintln(stdout, "")
		...
		fmt.Fprintln(stdout, "    --no-tui             Run without the TUI dashboard")
		fmt.Fprintln(stdout, "")
		...
		fmt.Fprintln(stdout, "")
		fmt.Fprintln(stdout, "get-session-status-oneline")
		fmt.Fprintln(stdout, "  Print all sessions' pane status on a single line.")
		fmt.Fprintln(stdout, "  TTY (interactive terminal): ANSI-colored dots matching the TUI.")
		...
		fmt.Fprintln(stdout, "    --config <path>      Config file path (optional)")
		fmt.Fprintln(stdout, "")
		fmt.Fprintln(stdout, "get-session-health")
		fmt.Fprintln(stdout, "  Print session health: node count, inbox/waiting counts per node.")
		fmt.Fprintln(stdout, "  Flags:")
		...
		fmt.Fprintln(stdout, "  List inbox message file paths for the current node.")
		fmt.Fprintln(stdout, "  Node name is auto-detected from tmux pane title.")
		fmt.Fprintln(stdout, "  Flags:")
		fmt.Fprintln(stdout, "    --config <path>      Config file path (optional)")
		fmt.Fprintln(stdout, "")
