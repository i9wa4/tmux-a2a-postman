...
func TestPlanDeliveryPolicy(t *testing.T) {
	...
	tests := []struct {
		...
		{
			name: "unknown recipient outranks missing evidence",
			in: deliveryPolicyInput{
				Info:                        baseInfo,
				RecipientResolved:           true,
				RecipientResolution:         router.Resolution{FailureReason: router.FailureUnknownNode},
				EvidencePresenceGateChecked: true,
				EvidencePresenceGateActive:  true,
				CompletionClaim:             true,
				EvidencePresent:             false,
		...
		{
			name: "routing denied outranks missing evidence",
			in: deliveryPolicyInput{
				Info:                        baseInfo,
				RecipientResolved:           true,
				RecipientResolution:         foundRecipient,
		...
		{
			name: "recipient session disabled outranks missing evidence",
			in: deliveryPolicyInput{
				Info:                        baseInfo,
				RecipientResolved:           true,
				RecipientResolution:         foundRecipient,
