...
| Skill discovery in `postman.md`      | `skill_path` exposes selected `SKILL.md` frontmatter in generated role context; `compaction_skill_path` can add runtime-selected catalogs only to compaction-triggered PINGs. | `skill_path` exposes selected `SKILL.md` frontmatter in generated role context; `compaction_skill_path` can add runtime-selected catalogs only to compaction-triggered PINGs. | Monitor                | [postman.md reference](../skills/postman-config-auditor/references/postman-md.md#2-global-frontmatter)                                                                                    | Harness maintainer when skill trigger semantics or catalog behavior changes.                                 | 2026-05-07         |
