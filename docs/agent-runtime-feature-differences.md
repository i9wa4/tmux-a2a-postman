...
| Skill discovery in `postman.md`      | `skill_path` exposes selected `SKILL.md` frontmatter in generated role context; Claude decides when to apply a skill.   | `skill_path` exposes selected `SKILL.md` frontmatter in generated role context; Codex decides when to apply a skill.    | Monitor                | [postman.md reference](../skills/postman-config-auditor/references/postman-md.md#2-global-frontmatter)                                                                                    | Harness maintainer when skill trigger semantics or `skill_path` catalog behavior changes.                    | 2026-05-06         |
